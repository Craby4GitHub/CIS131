...
public class IR4 {
	// Putting the Scanner object here makes it global so it does not have to be
	// passed to modules.
	static Scanner keyboard = new Scanner(System.in);

	public static void main(String[] args) {
		/**
		 * Main () - This program demonstrates various generalized input
		 * routines. This program also demonstrates generating a random number.
		 * 
		 * @param args
		 *            Arguments can be passed to this program but they are not
		 *            used.
		 */
		...
		do {
			...
			int numberOfRandomNbrs = getIntegerBetweenLowAndHigh(
					"How many random numbers do you want to generate? (1 to 20)", 1, 20, "Error: Outside Range");
	 ...
	 * 
	 * @param msg
	 *            is the text that will be displayed the user to ask them to
	 *            enter a value.
	 * @param low
	 *            is the lowest acceptable input value.
	 * @param high
	 *            is the highestt acceptable input value.
	...
	/**
	 * Gets an integer greater than the supplied parameter. Rejects null
	 * entries, any number of spaces, and non-numbers.
	 * 
	 * @param msg
	 *            is the text that will be displayed the user to ask them to
	 *            enter a value.
	 * @param low
	 *            is the highest unacceptable input value.
	 * @return Returns an int from the keyboard.
	 */
	...
	/**
	 * Gets an integer greater than or equal to the supplied parameter. Rejects
	 * null entries, any number of spaces, and non-numbers.
	 * 
	 * @param msg
	 *            is the text that will be displayed the user to ask them to
	 *            enter a value.
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * Gets a Character from the keyboard. Rejects null, spaces and
	 * non-characters.
	 * 
	 * @param msg
	 *            is the text that will be displayed the user to ask them to
	 *            enter a character.
	 * @return Returns an char from the keyboard.
	 */
	public static char getChar(String msg) {
		...
		char character = keyboard.next("[a-zA-Z]").charAt(0);
		keyboard.nextLine(); // flushes the buffer
		return character;
	}

	/**
	 * Gets a String from the keyboard. Rejects null entry or any number of
	 * spaces.
	 * 
	 * @param msg
	 *            is the text that will be displayed the user to ask them to
	...
	// ------------------------------------------------------------------------------------------------------------------
	/**
	 * Gets a Yes or No answer from the keyboard. Calls getString to rejects
	 * null input and spaces.
	 * 
	 * @param msg
	 *            is the text that will be displayed the user.
	...
	public static boolean getYorN(String msg) {
		...
		while (answer.compareToIgnoreCase("y") != 0 && answer.compareToIgnoreCase("yes") != 0
				&& answer.compareToIgnoreCase("n") != 0 && answer.compareToIgnoreCase("no") != 0) {
	...
	public static void closeScanner() {
		...
		} catch (Exception e) { // (Exception) catches all errors java might
								// throw here
